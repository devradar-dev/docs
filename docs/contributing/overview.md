...
description: How to contribute to DevRadar. Submit compatibility data, add AI tools, and improve documentation.
---
...
- [Adding AI Tools](/docs/contributing/adding-ai-tools) - Add new tools

---

**Ready to contribute?** [Submit Compatibility Data](/docs/contributing/adding-compatibility-rules) →
